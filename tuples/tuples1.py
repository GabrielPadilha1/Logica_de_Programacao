...
As tuplas são imutáveis, ou seja, seus valores não podem 
ser modificados após a criação.
...
- Crie uma nova tupla chamada cores_invertidas que seja a 
reversa da minha_tupla.
