...
O operador in verifica se um elemento está presente no 
conjunto.
...
elementos do primeiro conjunto que não estão presentes no segundo conjunto.


- Crie um conjunto chamado letras contendo as vogais do 
alfabeto: "a", "e", "i", "o", "u".
...
consoantes: "b", "d", "f".
- Verifique se o conjunto consoantes está contido no conjunto 
letras.
